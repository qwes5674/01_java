...
//    private static String brand; // 제품 브랜드
    ...
    // 3. 인스턴스 초기화 블럭
    {
         ...
         * 이미 static 초기화 블럭은 클래스가 로드될 때 이미 기본값으로 초기화를 진행했다.
         * 따라서 인스턴스 초기화 블럭이 동작하는 시점에는 이미 초기화가 진행된 정적 필드
...
//        price = 1300000;
    ...
    // 필드 값 전체 문자열 합치기해서 문자열 반환
    public String getInformation(){
        return "Product [name = " + this.name + " , " +
                "price = " + this.price + " , brand  = " + Product.brand + "]";
    }
}
