...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * 객체간의 상호 작용을 한다는 사실을  현실 세계와 동일하지만 의인화 기법이 적용되어
        * 현실세계에서 불가능한 무생물이나 개념 같은 존재들도 하나의 주제로
        * 본인의 상태를 스스로 제어하고 행동하도록 한다는 것이 현실 세계와는 다른 점
        ...
        * 유연성 확보는 여러 곳에 적용할 수 있는 유연한 객체를 의미하며, 재사용성이 늪아질 수 있게 한다는 의미
        ...
        * 이때 메시지(메소드)를 보내는 쪽은 송신자, 메시지(메소드)를 수신하는 쪽은 수신자라고 한다.
        * 수신자는 메시지를 전달 받아 그 메시지에 해당하는 내용을 처리하는 방법을 스스로 결정하고,
        * 그 결정할 방법 대로 처리할 명렁어들을 순차적으로 기술한 것 => 메소드
        *
        * 상호작용에 중요한 것은 메시지를 송수신하고 그 방법을 기술하여 메시지에 응답하는 상호작요을 설계하는것
        ...
        * */
        ...
        /*
        * 프로그램 요구사항
        * 1. 카레이서는 시동걸기, 엑셀레이터 밟기, 브레이크 밝기, 시동 끄기를 할 수 있다.
        * 2. 자동차는 시동걸기, 앞으로가기, 멈추기, 시동끄기를 할 수 있다.
        * 3. 자동차는 처음에 멈춘 상태로 대기하고 있다.
        * 4. 카레이서는 현재 자동차에 시동을 건다. (이미 걸려있는 경우 다시 시동을 걸 수 있다.)
