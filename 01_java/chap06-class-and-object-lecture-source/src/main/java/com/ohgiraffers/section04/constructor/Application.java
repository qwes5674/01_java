...
public class Application {
    public static void main(String[] args) {
        ...
        * 생성자 함수에 매개변수가 없는 생성자를 기본 생성자(defalut constructor) 라고 하며,
        ...
        * */
        ...
        // 매개변수 있는 생성자를 호출에 인스턴스 (객체) 생성
        User user2 = new User("user01","pass01","홍길동");
        System.out.println(user2.getInfo());

        // 모든 필드를 초기화 하는 생성자를 호출해 인스턴스(객체)를 생성
        User user3 = new User("user02","pass02","박효찬",new java.util.Date());
