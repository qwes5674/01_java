...
public class Application1 {
    public static void main(String[] args) {
        ...
        *  비교연산자
        *
        *  비교연산자 피연산자 사이에 상대적인 크기를 판단해 참 혹은 거짓을 반환하는 연산자이다.
        *  연산자 중 참 혹은 거짓을 반환하는 연산자는 삼황연산자의 조건식이나 조건문의 조건절에 많이 사용된다.
        * */

        /*
        *  비교연산자의 종류
        *  '==' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같으면 true 다르면 false를 반환
        *  '!=' : 왼쪾의 피연산자와 오른쪽의 피연산자가 다르면 true 같으면 false를 반환
        ...
        *  '<=' : 왼쪽의 피연산자가 오른쪽의 피연사자보다 작거나 같으면 true 아니면 false를 반환
        * */
        ...
        System.out.println("inum1과 inum2가 크거나 같은지 비교 : " + (inum1 >= inum2)); //false
        System.out.println("inum1과 inum2가 작은지 비교 : " + (inum1 < inum2)); //true
        System.out.println("inum1과 inum2가 작거나 같은지 비교 : " + (inum1 <= inum2)); //true
        ...
        System.out.println("dnum1과 dnum2보다 큰지 비교 : " + (dnum1 > dnum2)); //false
        System.out.println("dnum1과 dnum2가 크거나 같은지 비교 : " + (dnum1 >= dnum2)); //false
        System.out.println("dnum1과 dnum2가 작은지 비교 : " + (dnum1 < dnum2)); //true
        System.out.println("dnum1과 dnum2가 작거나 같은지 비교 : " + (dnum1 <= dnum2)); //true
        ...
        System.out.println("ch1과 ch2가 크거나 같은지 비교 : " + (ch1 >= ch2)); //true
        System.out.println("ch1과 ch2가 작은지 비교 : " + (ch1 < ch2)); //false
        System.out.println("ch1과 ch2가 작거나 같은지 비교 : " + (ch1 <= ch2));//false
   ...
   //     System.out.println("bool1과 bool2보다 큰지 비교 : " + (bool1 > bool2)); //true
   //     System.out.println("bool1과 bool2가 크거나 같은지 비교 : " + (bool1 >= bool2)); //true
   //     System.out.println("bool1과 bool2가 작은지 비교 : " + (bool1 < bool2)); //false
   //     System.out.println("bool1과 bool2가 작거나 같은지 비교 : " + (bool1 <= bool2));//false
    ...
    //    System.out.println("str1과 str2보다 큰지 비교 : " + (str1 > cstr2); //true
    //    System.out.println("str1과 str2가 크거나 같은지 비교 : " + (str1 >= str2)); //true
    //    System.out.println("str1과 str2가 작은지 비교 : " + (str1 < cstr2); //false
    //    System.out.println("str1과 str2가 작거나 같은지 비교 : " + (str1 <= str2));//false
