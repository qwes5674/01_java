...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 자바에서 컬렉션 프레임워크는 여러 개의 다양한 데이터들을 쉽고 효과적으로 처리 할 수 있도록
        * 표준화 된 방법을 제공하는 클래스들의 집합이다.
        * => 데이터를 효율적으로 저장하는 자료구조와 데이터를 처리하는 알고리즘을 미리 구현해놓은 클래서
        * */
        ...
        * 각 인터페이스 별 특징
        * 1. List 인터페이스
        *  - 순서가 있는 데이터의 집합으로 데이터의 중복 저장이 허용한다.
        ...
        * 레퍼런스 타입은 List로 해두는 게 더 유연한 코드를 작성 가능하다.
        * */

        List<Object> list = new ArrayList<>();

        /*
        * arrayList는 저장 순서가 유지되며, index(순번)이 적둉된다.
        ...
        * */
        ...
        //타입을 지정해서 타입 이외의 인스터스는 저장하지 않을 수 있다.
        // stringlist.add(123)
        ...
        * */
        ...
        /*
        * Interator
        * collection 인터페이스 iterator() 메소드를 이용하기 위해서 인스턴스를 생성 할 수 있다.
        * 컬렉션에서 값을 읽어오는 방식을 통하되게 제공하기 위해서 사용
        *
        * hasNext() : 다음 요소를 가지고 오는 경우 , treuㅡ 아니면 false반환
        * next() : 다음 요소를 반환
        * */
