...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 두 문자열이 같다면 0을 반환하고 인자로 전달된 문자열보다 작으면 음수, 크면 양수를 반환
        * 대소문자를 구분하여 비교함
        * */
        ...
        //compareToIggnorCase() : 대소문자 구분하지 않고 비교
        System.out.println("compareToIgnorCase() = " + str3.compareToIgnoreCase(str4));
        ...
        * */
        ...
        System.out.println("indexOf('a') = " + indexStr.indexOf('a'));
        System.out.println("indexOf('a') = " + indexStr.indexOf('z'));
        ...
        * */
        ...
        System.out.println("toUpperCase() = " + caseStr.toLowerCase()); // 전부 대문자로

        // 원본에는 영향을 주지 않는다.
        System.out.println("caseStr = " + caseStr); // JavaOracle

        /*
        * subString() : 문자열의 일부분을 잘라내여 새로운 문자열을 반환
        * 원본에 영향을 주지 않는다.
        * */
        String javaoracle = "javaoracle";

        System.out.println("subString(3,6) : " + javaoracle.substring(3,6)); //aor
        System.out.println("subString(3) : " + javaoracle.substring(3)); //aor
