...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *                   정상화된 문자열 패턴을 분리할 때 사용하기 좋다. (공백 문자열 무시)
        ...
        * */
        ...
        for(int i = 0 ;i < empArr1.length;i++){
            System.out.println("empArr1[" + i + "] : " + empArr1[i]); // 중간 값이 빈 문자열
        }

        System.out.println("=========== empArr2 ============"); // 마지막값이 출력 안됨
