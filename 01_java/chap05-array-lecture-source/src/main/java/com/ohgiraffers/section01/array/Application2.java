...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * hashcode() : 일반적으로 객체의 주소값을 10진수로 변환하여 생성한 객체의 고유한 정수값을 변환
        * -> 동일객체인지 비교할 때 사용할 목적으로 많이 쓰이며, 동등객체를 동일객체 취급하기 위한 용도로 overriding 해서 사용한다.
        * */
        ...
        System.out.println("larr2의 길이 : " + iarr2.length);
