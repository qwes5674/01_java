...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 형변환의 종류와 규칙
        * 1. 자동형변환 (목시적 형변환) : 컴파일러가 자동으로 수행해주는 타입 변환
        ...
        * */
        ...
        /* 자동형변환 규칙 테스트 */
        /* 작은 자료형에서 큰 자료형으로만 공간만 옮기는 경우 */

        byte bnum = 1;
        short snum = bnum;
        System.out.println("sum = " + snum);
        int inum = snum;
        ...
        // 실수끼리의 자동형변환
        float fnum = 4.0f; //실수는 double이 기본형이여서 f를 집어넣어야 한다.
        double dnum = fnum;

        //float result2 =  fnum + dnum;
        // fnum + dnum이 더 큰 double로 나와서 float으로 형변환 못함
        double result2 = fnum + dnum;
        System.out.println("result2 = " + result2);

        /*
        * 정수를 실수로 변경할 때, 소수점 자리가 없어도 실수 형태처럼 표현이 가능하다.
        * 이때, 데이터 손실이 없기 때문에, 자동 형변환이 된다.
        * 데이터 손실이 있을 경우에만 스스로 한다.
        * */
        ...
        /* int로 type이 명시적으로 정하지 않은 리터럴형태의 정수는 char형 변수에 기록 가능하다. */
        char ch2 = 65;
