...
public class Application1 {
    ...
    public static void main(String[] args) {
        /*
         * 표준 함수적 인터페이스
         * JDK 8 자주 사용되는 함수의 인터페이스를 표준 API로 제공하고 있다.
         * Consumer : 리턴값이 없는 accept() 메소드를 가지고 있다. (매개변수 소비자 역할)
         * Supplier : 매개변수가 없고, 리턴값이 있는 getXXX() 메소드를 가지고 있다.
         * Function : 매개변수가와 리턴값이 잇는 applyXXX() 메소드를 가지고 있다. (매개변수를 리턴값으로 매핑)
         * Operator : Function과 똑같이 applyXXX() 메소드를 가지고 있는데, 매개변수 연산을 할 후 동일한 타입으로 리턴
        ...
        /* BiConsumer<T, U> U>#accept(T t, U u) : void 객체 T, U를 받아 소비 */
        ...
        /* LongConsumer#accept(long value) void : void : long 값을 받아서 소비한다.*/
        ...
        ObjIntConsumer<java.util.Random> objIntConsumer =
                (((random, value) -> System.out.println("0부터 " + value + " 전 까지의 난수 발생 " + random.nextInt())));
        objIntConsumer.accept(new java.util.Random(), 20);
