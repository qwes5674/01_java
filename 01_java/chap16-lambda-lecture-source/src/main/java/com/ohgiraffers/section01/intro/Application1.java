...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 실행문이 한줄인 경우 {}를 생략 가능하다.
        * */

        /*
        * 인터페이스 정의된 추상메소드 활용하는 방법 3가지
        * 1. 인터페이스를 상속받는 클래스를 정의하여 기능을 완성 후 , 사용하는 방법
        ...
        * */
        ...
        System.out.println("10과 20의 합은? : " + c1.sumToNumber(10,20) ); //30
        ...
        System.out.println("20 과 30의 합은? : " + c2.sumToNumber(20,30)); //50

        // 3. 람다식을 활용한 방식
        Calculator c3 = (x,y) -> x + y;

        System.out.println("40 과 50의 합은? : " + c3.sumToNumber(40,50));
