...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        // 추상메서드, 클래스를 사용하기 위해서는 추상클래스를 상속받은 객체를 이용해야 한다.
