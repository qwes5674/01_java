...
public class Application1 {
    ...
    *    수신 할 수 있다. 동일한 메시지를 수신하고 처리할 때 객체별로 다르게 할 수 있다는
    *    장점을 가짐
...
//        Tiger t = new Tiger();
        ...
        * 런타임 당시 실제 객체가 가진 오버라이딩 메소드로 바인딩이 바뀌어 동작하는 것
        * */
        a1.cry();
        a2.cry();

        // 현재 레퍼런스 변수의 타입이 Animal이기 떄문에
...
//        a2.bite();
        ...
        //클래스의 업캐스팅과 다운캐스팅
        /*
        * 클래스의 형변환은 up-casting 과 down-casting으로 구분할 수 있다.
