...
public class Application2 {
    public static void main(String[] args) {
        ...
        // 수업 목표: 값을 연산하여 출력 할 수 있다.
        // 이 때 값의 형태에 따라 사용 할 수 있는 연산자의 종류와 연산이 결과가 달라진다.
        ...
        System.out.println(1.23 - 0.23); // 계산의 결과는 실수의 형태로 나온다.
        ...
        // 문자와 문자의 연산
        // 문자는 내부적으로 숫자로 인식되어 연산된다.( ASCII CODE)
        ...
        * */
        ...
        System.out.println("teageun" + 123); // 정수와의 연산
        System.out.println("teageun" + 123.456); // 실수와의 연산
        System.out.println("teageun" + 'a'); // 문자와의 연산
        System.out.println("teageun" + true); // 논리값과의 연산
        ...
        // 논리값과 실수의 연산도 마찬가지로 안됩니다.
        // 논리값과 문자의 연산도 마찬가지로 안됩니다.
        // 논리값과 문자열의 연산
