...
public class Application3 {
    public static void main(String[] args) {
         ...
         *        상수를 사용할 때 특수하게 사용한다.
         *    2-4. 한줄로 변수명을 짓는게 가능 하지만, 권장되지 않는다. (한글을 취급하는 다양한 방식때문에 에러 유발)
         *    2-5. 변수 안에 저장된 값이 어떤 의미를 갖는지는 명확하게 표연하도록 한다.
         *    2-6. 전형적인 변수 이름이 있다면 가급적 사용하도록 한다.
         *    2-7. 명사형으로 작성 할 수 있도록 한다.
         *    2-8. boolean 형은 의문문으로 가급적 긍정의 형태로 네이밍 합니다.
         * */
        ...
        //int age; //사용가능한 특수 문자 외에는 사용이 불가능하다.
        //int a@ge;
        int _age= 20; // 언더스코어(_) 사용 가능하다. 처음 중간 마지막 상관 없음.
        int $h$arp$ = 20;  // $ 사용 가능하다. 처음 중간 마지막 상관 없음.

        //암묵적 약속

        // 변수의 길이에는 제한이 없지만, 적당히 하자.
        int qwerqwertqwedv; // 이렇게 사용 하지는 말자.
